...
The **Create client** wizard has three pages, and the settings this guide needs are spread across all three. The page numbers appear down the left side of the wizard.
